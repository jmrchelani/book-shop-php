                            ...
                            <div class="card shadow border-left-primary py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col mr-2">
                                            <div class="text-uppercase text-primary font-weight-bold text-xs mb-1"><span>TRAnsactions</span></div>
                                            <div class="text-dark font-weight-bold h5 mb-0"><span><?php echo $trcount; ?></span></div>
                                        </div>
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-left-success py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col mr-2">
                                            <div class="text-uppercase text-success font-weight-bold text-xs mb-1"><span>AMount spent</span></div>
                                            <div class="text-dark font-weight-bold h5 mb-0"><span><?php echo $spent; ?></span></div>
                                        </div>
