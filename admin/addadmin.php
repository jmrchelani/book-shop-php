...
$username_err = $password_err = $email_err = $name_err = $add_err = "";
$added = false;
...
<head>
    ...
    <title>Add Admin - BibliOphile</title>
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <?php 
                            if(!empty($add_err)){
                                ...
                                echo '<div class="alert alert-success">"Added admin successfully."</div>';
                            }
                        ?>
                        ...
                        <div class="form-group">
                            <input type="text" name="password" class="form-control <?php echo (!empty($password_err)) ? 'is-invalid' : ''; ?>" placeholder = "Password">
