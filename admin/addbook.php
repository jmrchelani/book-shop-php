...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($name_err) && empty($isbn_err) && empty($author_err) && empty($price_err) && empty($descr_err) && $uploadOk != 0){
        ...
        if($result = mysqli_query($conn, $sql)) {
            ...
            if (mysqli_num_rows($result) > 0) {
                $add_err = "ISBN already exists.";
            } else {
                $sql = "INSERT INTO `books` (`ISBN`, `Author`, `Name`, `Description`, `Price`, `Img`) VALUES ('". $isbn ."', '". $author ."', '". $name ."', '". $descr ."', ". $price .", '". $image ."')";
                if($result = mysqli_query($conn, $sql)) {
                    $added = true;
                    if ($uploadOk == 0) {
                        $upload_err = "There was an error uploading this image.";
...
<head>
    ...
    <title>Add Book - BibliOphile</title>
    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-1">Add Book</h3>
                </div>
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <?php 
                            if(!empty($add_err)){
                                ...
                                echo '<div class="alert alert-success">"Added book successfully."</div>';
                            }
                        ?>
